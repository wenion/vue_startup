...
var _chunkMA4DMWLMjs = require('./chunk-MA4DMWLM.js');
...
function normalizeImport(info, name) {
  ...
  return _chunkMA4DMWLMjs.__spreadValues.call(void 0, {
    name,
    as: name
  }, info);
}
...
${dts2}`;
  ...
  function writeConfigFiles() {
    ...
    if (dts) {
      ...
      if (content !== lastDTS) {
        lastDTS = content;
        promises.push(_fs.promises.writeFile(dts, generateDTS(dts), "utf-8"));
      }
    }
...
function flattenImports(map, overriding = false) {
  ...
  _utils.toArray.call(void 0, map).forEach((definition) => {
    if (typeof definition === "string") {
      if (!_chunkMA4DMWLMjs.presets[definition])
        throw new Error(`[auto-import] preset ${definition} not found`);
      const preset = _chunkMA4DMWLMjs.presets[definition];
